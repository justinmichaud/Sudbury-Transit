...
//                }
//
//                navigate(new GeoPoint(from.geometry.coordinates[1], from.geometry.coordinates[0]),
//                        new GeoPoint(to.geometry.coordinates[1], to.geometry.coordinates[0]));
//            }
//        });
...
//    ***** Disabled until we can get more data from the city to increase accuracy ********
//    *************************************************************************************
